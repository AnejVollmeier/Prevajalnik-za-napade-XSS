...
export default function Analyze() {
  ...
  const [analysisMode, setAnalysisMode] = useState('single'); // 'single' or 'project'
    ...
    <div className="container py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 mb-8">
          Upload a .js file, whole project (.zip), or paste code to check for XSS vulnerabilities
        </p>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
            ...
            >
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-500 text-sm mt-1">
                  Supported: .js files (max 200KB) or .zip projects
                </p>
                <button
                  type="button"
          ...
          <div className="flex gap-4">
            <button
              type="submit"
              disabled={loading || (analysisMode === 'single' ? !code.trim() : fileCount === 0)}
            ...
            >
              {loading ? 'Analyzing...' : `Analyze ${analysisMode === 'project' ? 'Project' : 'Code'}`}
            </button>
